...
| `host_service_started` | info | lss-backup-server.service started | journalctl _SYSTEMD_UNIT |
| `host_service_stopped` | warn | lss-backup-server.service stopped | journalctl _SYSTEMD_UNIT |
| `host_service_failed` | critical | lss-backup-server.service crashed | journalctl _SYSTEMD_UNIT |
